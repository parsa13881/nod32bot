...
local function run(msg, matches)
  if matches[1]:lower() == 'firebot' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "firebot" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (firebot)",-- Put everything you like :)
		"^[!/]([Ff]irebot)"-- Put everything you like :)
    }, 
  run = run
}
